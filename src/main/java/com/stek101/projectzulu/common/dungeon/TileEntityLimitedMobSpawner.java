...
public class TileEntityLimitedMobSpawner extends TileEntity {
                        ...
                        if (var11 == null || canSpawnHere) {
                            ...
                            if (spawnerTags != null) {
                               ...
                               //         new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 64));
                            	PZPacketPlaySound message = new PZPacketPlaySound().setPacketData(xCoord, yCoord, zCoord,
                                                 spawnerTags.spawnSound);
                            	ProjectZulu_Core.packetHandler.sendToAllAround(message, new TargetPoint(worldObj.provider.dimensionId, xCoord, yCoord, zCoord, 64));
    ...
    public void syncToServer() {
        ...
        PZPacketMobSpawner message = new PZPacketMobSpawner().setPacketData(xCoord, yCoord, zCoord, tileEntityData);
