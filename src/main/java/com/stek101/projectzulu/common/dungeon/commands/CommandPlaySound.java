...
public class CommandPlaySound extends CommandBase {
    ...
    public void processCommand(ICommandSender commandSender, String[] stringArgs) {
        if (stringArgs.length < 2) {
            ...
            PZPacketPlaySound message = new PZPacketPlaySound().setPacketData(soundTargetX, soundTargetY, soundTargetZ,
                           stringArgs[1]);
            ProjectZulu_Core.packetHandler.sendToAllAround(message, new TargetPoint(targetPlayer.dimension, soundTargetX, soundTargetY, soundTargetZ, soundRange));
        }
    }
