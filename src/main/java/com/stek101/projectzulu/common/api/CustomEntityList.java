...
public enum CustomEntityList {
    ...
    REDFINCH, BLUEFINCH, GREENFINCH, GORILLA, GIRAFFE, ELEPHANT, HORSE, EAGLE, HORNBILL, PELICAN, MINOTAUR, HAUNTEDARMOR, 
    CENTIPEDE, HORSERANDOM, LIZARDSPIT, FOLLOWER, YELLOWFINCH, GOAT, DUCK, DUCKEGG, DEER, SKELETONN, FISHA, RIPPERFIN,
    OSTRICHEGG, GIANTRAT, FISHB, CROW, CAMEL, MONKEY, THROWINGROCK, RAVAGERANT, BEETLEAS, BEETLEBS, BLOOMDOOM, PZBAT;
