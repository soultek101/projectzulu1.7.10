...
public class EntityAIAttackOnCollideWater extends EntityAIBase
{
    ...
    public EntityAIAttackOnCollideWater(EntityGenericWaterMob par1EntityLiving, Class par2Class, float par3, boolean par4, float attackDistanceSq) {
        this.attackTick = 0;
    ...
    public EntityAIAttackOnCollideWater(EntityGenericWaterMob par1EntityLiving, Class par2Class, float par3, boolean par4) {
        this(par1EntityLiving, par2Class, par3, par4, par1EntityLiving.width * 2.0F * par1EntityLiving.width * 2.0F);
    }
    
    public EntityAIAttackOnCollideWater(EntityGenericWaterMob par1EntityLiving, float par2, boolean par3) {
    	this(par1EntityLiving, null, par2, par3);
    }
    public EntityAIAttackOnCollideWater(EntityGenericWaterMob par1EntityLiving, float par2, boolean par3, float attackDistanceSq ) {
