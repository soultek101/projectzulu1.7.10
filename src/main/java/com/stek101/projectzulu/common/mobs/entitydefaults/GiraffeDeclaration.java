...
import com.stek101.projectzulu.common.mobs.models.ModelGiraffe;
...
public class GiraffeDeclaration extends SpawnableDeclaration {
    ...
    public void outputDataToList(Configuration config, CustomMobData customMobData) {
        ...
        customMobData.entityProperties = new EntityProperties(20f, 5.0f, 0.3f, 0.0f, 0.5f, 32.0f, 20.0f, 16D).createFromConfig(
                config, mobName);
