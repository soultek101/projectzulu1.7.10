...
public class RenderMammoth extends RenderGenericLiving {
    ...
    public RenderMammoth(ModelBase par1ModelBase, float shadowSize) {
        super(par1ModelBase, shadowSize, new ResourceLocation(DefaultProps.mobKey, "textures/mammoth.png"));
        snowWild = new ResourceLocation(DefaultProps.mobKey, "textures/mammoth_snow.png");
        wildSaddle = new ResourceLocation(DefaultProps.mobKey, "textures/mammoth_saddle.png");
        snowSaddle = new ResourceLocation(DefaultProps.mobKey, "textures/mammoth_snow_saddle.png");
    }
