...
import com.stek101.projectzulu.common.mobs.entity.EntityHorseGrey;
...
public class HorseGreyDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, new ResourceLocation(DefaultProps.mobKey,
                "textures/horse/horse_grey.png"), new ResourceLocation(DefaultProps.mobKey, 
                		"textures/horse/horse_grey_saddled.png"));
    }
