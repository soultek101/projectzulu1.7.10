...
public class EntityAntRavager extends EntityGenericAnimal implements IAnimals {
	private EntityAFightorFlight EAFF;
	private CustomEntityList entityEntry;
	private float aggroLevel;
	private double aggroRange;
   
	public EntityAntRavager(World par1World) {
      super(par1World);
      ...
      /* Check if aggroLevel and aggroRange have valid values to activate AFoF */
        ...
        tasks.addTask(4, new EntityAIAttackOnCollide(this, 1.0f, false));
    ...
    protected String getLivingSound() {
        return DefaultProps.mobKey + ":" + DefaultProps.entitySounds + "ravantlivingsound";
    }
    ...
    protected String getHurtSound() {
        return DefaultProps.mobKey + ":" + DefaultProps.entitySounds + "ravanthurtsound";
    }
    ...
    public boolean isValidBreedingItem(ItemStack itemStack) {
        if (itemStack != null
                && (itemStack.getItem() == Items.bread || itemStack.getItem() == Items.spider_eye)) {
