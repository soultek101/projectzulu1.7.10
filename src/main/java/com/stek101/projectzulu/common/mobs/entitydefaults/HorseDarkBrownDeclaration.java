...
import com.stek101.projectzulu.common.mobs.entity.EntityHorseDarkBrown;
...
public class HorseDarkBrownDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, new ResourceLocation(DefaultProps.mobKey,
                "textures/Horse/horse_dark_brown.png"), new ResourceLocation(DefaultProps.mobKey,
                "textures/Horse/horse_dark_brown_saddled.png"));
    }
