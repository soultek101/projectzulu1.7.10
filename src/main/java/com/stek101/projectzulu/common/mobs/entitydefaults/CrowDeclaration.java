...
import com.stek101.projectzulu.common.mobs.models.ModelCrow;
...
public class CrowDeclaration extends SpawnableDeclaration {

    public CrowDeclaration() {
        super("Crow", 57, EntityCrow.class, EnumCreatureType.ambient);
        setSpawnProperties(10, 5, 1, 1);
        setRegistrationProperties(128, 3, true);
        setDropAmount(0, 1);

        eggColor1 = (211 << 16) + (211 << 8) + 255;
        eggColor2 = (1344 << 16) + (133 << 8) + 255;
    }
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericLiving(new ModelCrow(), 0.5f, new ResourceLocation(DefaultProps.mobKey,
                "textures/crow0.png"));
    }
