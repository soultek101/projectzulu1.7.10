...
import com.stek101.projectzulu.common.mobs.entity.EntityEagle;
import com.stek101.projectzulu.common.mobs.models.ModelEagle;
...
public class EagleDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericLiving(new ModelEagle(), 0.5f, new ResourceLocation(DefaultProps.mobKey, 
        		"textures/eagle.png"));
    }
