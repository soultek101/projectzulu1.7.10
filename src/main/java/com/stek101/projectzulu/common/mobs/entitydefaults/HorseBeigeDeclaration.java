...
import com.stek101.projectzulu.common.mobs.entity.EntityHorseBeige;
...
public class HorseBeigeDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, new ResourceLocation(DefaultProps.mobKey,
                "textures/horse/horse_beige.png"), new ResourceLocation(DefaultProps.mobKey, 
                		"textures/horse/horse_beige_saddled.png"));
    }
