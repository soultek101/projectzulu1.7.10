...
import com.stek101.projectzulu.common.mobs.models.ModelTreeEnt;
import com.stek101.projectzulu.common.mobs.renders.RenderSnow;
...
public class TreeEntDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderSnow(new ModelTreeEnt(), 0.5f, new ResourceLocation(DefaultProps.mobKey, "textures/treeent.png"),
                new ResourceLocation(DefaultProps.mobKey, "textures/treeent_snow.png"));
    }
