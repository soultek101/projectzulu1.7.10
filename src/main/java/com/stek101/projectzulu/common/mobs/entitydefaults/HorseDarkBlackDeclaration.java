...
import com.stek101.projectzulu.common.mobs.entity.EntityHorseDarkBlack;
...
public class HorseDarkBlackDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, new ResourceLocation(DefaultProps.mobKey,
                "textures/Horse/horse_dark_black.png"), new ResourceLocation(DefaultProps.mobKey,
                "textures/Horse/horse_dark_black_saddled.png"));
    }
