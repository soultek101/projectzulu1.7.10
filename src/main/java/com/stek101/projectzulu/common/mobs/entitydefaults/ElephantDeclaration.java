...
import com.stek101.projectzulu.common.mobs.entity.EntityElephant;
import com.stek101.projectzulu.common.mobs.models.ModelElephant;
...
public class ElephantDeclaration extends SpawnableDeclaration {
    ...
    public void outputDataToList(Configuration config, CustomMobData customMobData) {
        ...
        ConfigHelper.configDropToMobData(config, "MOB CONTROLS." + mobName, customMobData,
                ItemList.genericCraftingItems, ItemGenerics.Properties.LargeHeart.meta(), 5);
        customMobData.entityProperties = new EntityProperties(30f, 5.0f, 0.3f, 0.0f, 0.5f, 32.0f, 30.0f, 16D).createFromConfig(
                config, mobName);
