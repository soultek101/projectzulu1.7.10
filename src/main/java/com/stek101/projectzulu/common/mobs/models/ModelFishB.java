...
public class ModelFishB extends ModelBase
{
  ...
  public ModelFishB()
  {
    ...
    textureHeight = 32;
      ...
      topFin.setRotationPoint(0F, 18F, -1F);
      ...
      bottomFin.setRotationPoint(0F, 20F, -1F);
      ...
      backFinBase.addBox(-0.5F, -1.5F, 0F, 1, 3, 3);
      backFinBase.setRotationPoint(0F, 19.5F, 3F);
      ...
      backFinBottom.setRotationPoint(0F, 0F, 2.5F);
      ...
      backFinTop.setRotationPoint(0F, -0F, 2.5F);
  ...
  public void setLivingAnimations(EntityLivingBase par1EntityLiving, float par2, float par3, float par4) {
	EntityFishB var5 = (EntityFishB) par1EntityLiving;
