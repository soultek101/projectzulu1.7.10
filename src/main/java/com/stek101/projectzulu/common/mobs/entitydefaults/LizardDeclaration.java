...
import com.stek101.projectzulu.common.mobs.entity.EntityLizard;
import com.stek101.projectzulu.common.mobs.models.ModelLizard;
...
public class LizardDeclaration extends SpawnableDeclaration {
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericLiving(new ModelLizard(), 0.5f, new ResourceLocation(DefaultProps.mobKey, 
        		"textures/lizard.png"));
    }
