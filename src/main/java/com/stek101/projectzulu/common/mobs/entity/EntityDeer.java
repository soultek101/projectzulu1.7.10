...
public class EntityDeer extends EntityGenericAnimal implements IAnimals {
    ...
    protected String getLivingSound() {
        return DefaultProps.mobKey + ":" + DefaultProps.entitySounds + "deerlivingsound";
    }
    ...
    protected String getHurtSound() {
        return DefaultProps.mobKey + ":" + DefaultProps.entitySounds + "deerhurtsound";
    }
