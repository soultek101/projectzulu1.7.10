...
import com.stek101.projectzulu.common.mobs.entity.EntityBeaver;
import com.stek101.projectzulu.common.mobs.models.ModelBeaver;
...
public class BeaverDeclaration extends SpawnableDeclaration {
    ...
    public void outputDataToList(Configuration config, CustomMobData customMobData) {
        ...
        customMobData.entityProperties = new EntityProperties(10f, 2.0f, 0.2f, 0.0f, 0.0f, 32.0f, 10.0f, 16D).createFromConfig(
                config, mobName);
    ...
    public RenderWrapper getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericLiving(new ModelBeaver(), 0.5f, new ResourceLocation(DefaultProps.mobKey, 
        		"textures/beaver.png"));
    }
