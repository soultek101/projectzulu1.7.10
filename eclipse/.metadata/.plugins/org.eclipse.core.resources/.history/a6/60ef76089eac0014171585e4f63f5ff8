...
public class DefaultProps {
    ...
    public static final String VERSION_STRING = "1.7.10-1.4b3";
...
//    public static final String blockSpriteSheet = blockDiretory + "/textures/blocks_projectzulu.png"; // TODO: Delete
//    public static final String itemSpriteSheet = blockDiretory + "/textures/items_projectzulu.png"; // TODO: Delete
