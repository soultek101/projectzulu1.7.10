...
import com.ngb.projectzulu.common.mobs.entity.EntityMammoth;
import com.ngb.projectzulu.common.mobs.models.ModelMammoth;
import com.ngb.projectzulu.common.mobs.renders.RenderMammoth;
